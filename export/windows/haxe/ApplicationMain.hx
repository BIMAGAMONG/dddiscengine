...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DDDiscEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("DDDiscEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		#elseif air
		app.window.title = "Doki Doki Disc Engine!";
		#else
