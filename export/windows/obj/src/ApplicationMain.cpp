...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("DDDiscEngine",97,70,48,42),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("bimagamongMOP",5e,ae,01,a2));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("DDDiscEngine",97,70,48,42));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Doki Doki Disc Engine!",f4,ee,bd,07));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Doki Doki Disc Engine!",f4,ee,bd,07))
